...
urlpatterns = [
    ...
    url('^resultados/(?P<eleccion_id>\d+)/$', cached(views.ResultadosOficialesEleccion.as_view()), name='resultados-eleccion'),
    url('^resultados$', cached(views.ResultadosOficialesElecciones.as_view()), name='resultados'),
